...
# Template: app
# Command: /usr/bin/qmake -o Makefile oop_prak4.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = oop_prak41.0.0
DISTDIR = /home/porofieff/Documents/Leti/OOP/Practise/oop_prak4/.tmp/oop_prak41.0.0
LINK          = clang++
...
SOURCES       = array.cpp \
		...
		main.cpp \
		interface.cpp \
		polinome.cpp moc_interface.cpp
OBJECTS       = array.o \
		complex.o \
		main.o \
		interface.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		oop_prak4.pro array.h \
		complex.h \
		interface.h \
		number.h \
		polinome.h \
		ui_interface.h array.cpp \
		complex.cpp \
		main.cpp \
		interface.cpp \
		polinome.cpp
QMAKE_TARGET  = oop_prak4
DESTDIR       = 
TARGET        = oop_prak4
...
oop_prak4: ui_interface.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: oop_prak4.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		oop_prak4.pro
	$(QMAKE) -o Makefile oop_prak4.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents array.h complex.h interface.h number.h polinome.h ui_interface.h $(DISTDIR)/
	$(COPY_FILE) --parents array.cpp complex.cpp main.cpp interface.cpp polinome.cpp $(DISTDIR)/
	$(COPY_FILE) --parents interface.ui $(DISTDIR)/
...
moc_interface.cpp: interface.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/porofieff/Documents/Leti/OOP/Practise/oop_prak4/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-clang -I/home/porofieff/Documents/Leti/OOP/Practise/oop_prak4 -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/14.2.1 -I/usr/include/c++/14.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/14.2.1/backward -I/usr/lib/clang/18/include -I/usr/local/include -I/usr/include interface.h -o moc_interface.cpp
...
ui_interface.h: interface.ui \
		/usr/bin/uic
	/usr/bin/uic interface.ui -o ui_interface.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/oop_prak4/bin || mkdir -p $(INSTALL_ROOT)/opt/oop_prak4/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/oop_prak4/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/oop_prak4/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/oop_prak4/bin/ 
